...
?>
< class="w-screen h-auto  bg-blue-950 text-white overflow-y-auto">

    <div class="relative w-full h-auto overflow-y-auto">
        <!-- Slide -->

        <div class=" w-full h-auto slideshow">
            <div class="slides h-[400px] w-[600px] bg-gray-400  mt-[40px] left-1/2  -translate-x-1/2  absolute rounded-lg  ">
...
<!-- On today -->
    <div class="today bg-white w-screen h-screen mt-[480px] top-full">
        <div class="p-4">

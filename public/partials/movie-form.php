        ...
        <div class="flex h-full w-full px-8 py-6">
            <div class=" flex flex-col justify-between items-start h-full w-2/3 "  >
                ...
                <div class="flex flex-col items-start w-full">
                    ...
                    <input  class="block w-full rounded-sm text-app-blue  font-semibold border-none outline-none ring-0 px-2 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-500    border-2  peer invalid:[&:not(:placeholder-shown):not(:focus)]:border-app-orange" type="text" name="title" id="title" value=" <?php echo $_SESSION['movie_form']?$form_movie['movie_title'] : '' ; ?> " required  pattern=".{1,}">
                </div>

                <!-- cast -->
                <div class="grid grid-cols-3 gap-x-4 mt-3">
                    <div class="flex flex-col items-start">
                        <label for="cast1" class="mb-1">Cast #1<span class="text-app-orange">*</span></label>
                        <input type="text" name="cast1" id="cast1" class=" w-full  ">
                    </div>
                    <div class="flex flex-col items-start">
                        <label for="cast2" class="mb-1">Cast #2<span class="text-app-orange">*</span></label>
                        <input type="text" name="cast2" id="cast2" class=" w-full  ">
                    </div>
                    <div class="flex flex-col items-start">
                        <label for="cast3" class="mb-1">Cast #3<span class="text-app-orange">*</span></label>
                        <input type="text" name="cast3" id="cast3" class=" w-full  ">
                    </div>
                </div>
                ...
                <div class="flex flex-col items-start w-full">
                    ...
                    <textarea class="text-app-blue font-semibold w-full rounded-sm focus:outline-app-blue px-1 py-[2px]" name="plot" id="plot" cols="10" rows="3"  required><?php echo $_SESSION['movie_form']?$form_movie['movie_plot'] : '' ; ?></textarea>
                </div>
                ...
                <div class="flex justify-between w-full">
                    ...
                    <!-- release date -->
                    <div class="flex flex-col items-start w-1/4">
                        <label for="rating" class=" mt-3 mb-1" >Release Date<span class="text-app-orange">*</span></label>
                        <input class="text-app-blue font-semibold  w-full rounded-sm focus:outline-app-blue px-1 py-[2px]" type="date" name="rating" id="rating"  value=" <?php echo $_SESSION['movie_form']?$form_movie['movie_rating'] : '' ; ?> " required/>
                    </div>

                    <!-- rating -->
                    <div class="inline-flex flex-col items-start w-1/4">

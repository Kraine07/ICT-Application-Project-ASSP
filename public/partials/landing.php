...
<div id="login-form" class="bg-[#ffffffbb] absolute top-0 left-30 z-50 hidden w-full h-screen">
    <div id="" class="shadow-custom bg-zinc-200  w-[300px] p-8 top-12 right-12 absolute z-50">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p class="text-xs mt-2 text-red-500 italic">* Required fields </p>
        </div>
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-xs">
            <form action="login.php" method="post">
                ...
                <div class="mt-2">
                    <div class="">
                    <label for="password"><span class="text-red-500">*</span> Password</label>

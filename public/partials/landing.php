...
<div class="relative overflow-hidden  h-full w-full">
    <div class="flex  h-full w-full">
        ...
        <div class=" w-3/5  flex flex-col justify-evenly items-end z-10">
            <button id="login" class=" bg-app-tertiary text-white text-xs py-1 px-2 rounded-l-full justify-self-start">
            ...
            <div class=" w-[200px] md:w-3/4 flex flex-col items-end mr-12 justify-between">
                ...
                <a href="main.php" class="bg-app-orange text-app-blue text-center text-xl font-semibold py-1 w-full rounded-full my-8  ">Enter

...
function showErrorMessage($message, $redirect="index"){
    ...
    <div class="h-screen w-screen bg-app-modal  absolute z-30">
        <div class="w-[400px] h-auto  absolute z-30  left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 ">
            <div class=" bg-white animate-zoom-in border border-red-500 " >
                ...
                <div class="flex flex-col m-6">
                    ...
                    <a href="'.$redirect.'.php" class="block text-sm text-white text-center font-semibold self-end cursor-pointer  bg-red-500 py-1 w-[100px] rounded-full">OK</a>
                </div>
            </div>
        </div>
    </div>
...
function showSuccessMessage($message, $redirect="index"){
    ...
    <div class="h-screen w-screen bg-app-modal absolute z-30">
        <div class="w-[400px] h-auto absolute z-30 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <div class="bg-white animate-zoom-in border border-green-500 ">
                ...
                <div class="flex flex-col m-6">
                    <span class=" text-sm mb-4  block">'. $message . ' </span>
                    <a href="'.$redirect.'.php" class="block text-sm text-white text-center font-semibold self-end cursor-pointer  bg-green-500 py-1 w-[100px] rounded-full">OK</a>
                </div>
            </div>
        </div>
    </div>
